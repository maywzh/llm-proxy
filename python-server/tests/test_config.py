...
class TestGetConfig:
    ...
    def test_get_config_returns_cached_instance(self, clear_config_cache):
...
class TestAppEnvConfig:
    ...
    def test_get_env_config(self, monkeypatch):
        ...
        assert isinstance(config, AppEnvConfig)
        assert config.db_url == 'postgresql://localhost/test'
